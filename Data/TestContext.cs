...
public partial class TestContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Alumno>(entity =>
        {
            ...
            entity.Property(e => e.AlumnoId).ValueGeneratedOnAdd();
        ...
        {
            entity.HasKey(e => e.ContactoId).HasName("PK__Contacto__8E0F85E8116A8DA6");
        ...
        {
            entity.HasKey(e => e.MensajeId).HasName("PK__Mensajes__FEA0555FB9178A02");
